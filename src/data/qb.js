export const QB = [
  ...
  {id:"q4",exam:"IELTS",section:"Reading – T/F/NG",pid:"P1",difficulty:3,
   ...
   explanation:"❌ NOT GIVEN — T/F/NG Strategy: When the passage mentions something (the study) but says nothing about whether it was the FIRST, the answer is Not Given.\n\n🔍 Evidence: The passage discusses the Sheffield study's findings but never claims it was the first or compares it to prior research.\n\n⚠️ Trap: Don't assume 'first' just because only one study is mentioned. The passage must explicitly state it was the first.\n\n💡 Key skill: 'First', 'only', 'best', 'always' — these absolutes in the question are T/F/NG red flags. Check if the passage explicitly claims the absolute."},
  ...
  {id:"q9",exam:"IELTS",section:"Reading – T/F/NG",pid:"P2",difficulty:3,
   ...
   options:["True","False","Not Given"],answer:"False",
   explanation:"❌ FALSE — T/F/NG Strategy: When the passage says the OPPOSITE of the statement, the answer is False.\n\n🔍 Evidence: The passage says 'a phenomenon researchers have yet to fully explain.' The question says 'fully explained' — direct contradiction.\n\n⚠️ Trap: 'Yet to fully explain' ≠ 'haven't explained at all.' Scientists may partially understand it. But 'fully explain' vs 'yet to fully explain' is a clear contradiction → FALSE.\n\n💡 Key skill: Look for direct opposites. 'Fully explained' vs 'yet to fully explain' is a textbook False signal."},
  ...
  {id:"q15",exam:"IELTS",section:"Reading – T/F/NG",pid:"P3",difficulty:3,
   ...
   options:["True","False","Not Given"],answer:"Not Given",
   explanation:"❌ NOT GIVEN — T/F/NG Strategy: When the passage makes a claim ('one of the greatest threats') but doesn't COMPARE it to something specific in the question (climate change), the answer is Not Given.\n\n🔍 Evidence: The passage says the WHO calls AMR 'one of the greatest threats to global health.' This is a general statement — it never ranks AMR against climate change or any other specific threat.\n\n⚠️ Trap: You might think 'one of the greatest' implies it could be greater than climate change. Don't infer! T/F/NG tests what the passage STATES, not what you can logically deduce.\n\n💡 Key skill: 'Greater than X' requires an explicit comparison. If the passage never mentions X, or mentions both without comparing them → NOT GIVEN."},
  ...
  {id:"q31",exam:"IELTS",section:"Reading – Multiple Choice",pid:"P6",difficulty:3,
   ...
   explanation:"✅ Multiple Choice Strategy: For 'main argument' questions, look for the thesis statement — usually in the introduction or conclusion.\n\n🔍 Evidence: 'Regulatory measures alone are insufficient without fundamental changes to production and consumption patterns.' This is the passage's core claim.\n\n❌ A: Contradicted — the passage argues bans alone are NOT sufficient.\n❌ B: Contradicted — the passage doesn't argue they're unnecessary, just incomplete.\n❌ D: The 50% figure is fabricated — the passage never makes this claim.\n\n💡 Key skill: Wrong options often use extreme language ('most effective', 'unnecessary') or invented statistics. The correct answer uses qualified language ('insufficient without...')."},
