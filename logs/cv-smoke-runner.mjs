...
var rawLLMData = {
  fullName: { extractedValue: "Ada Okafor", exactQuote: "Ada Okafor" },
  degreeClass: { extractedValue: "First Class Honours", exactQuote: "First Class Honours" },
  degreeInstitution: { extractedValue: "University of Lagos", exactQuote: "University of Lagos" },
  graduationYear: { extractedValue: "2022", exactQuote: "2022" },
  skills: { extractedValue: ["Python", "React", "Data Analysis", "SQL"], exactQuote: "Python" }
};
